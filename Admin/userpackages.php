        ...
        buttons: [
            ...
            'copy', 'csv', 'excel', 'pdf', 'print'
                    ...
                    "ajax":{
                        ...
                        url :"ajax-userpackages.php", // json datasource
...
<script type="text/javascript">
    function setInActive(user_id){
        ...
        $.ajax({
            type :'post',
            url : 'ajax-user.php?action=inactiveuserpackage',
            data :'id='+user_id,
    ...
    function setActive(user_id){
        ...
        $.ajax({
            type :'post',
            url : 'ajax-user.php?action=activeuserpackage',
            data :'id='+user_id,
            success : function (data){
                location.reload();
            }
