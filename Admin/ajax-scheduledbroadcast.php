...
$sql.=" FROM job_broadcast WHERE id!='' and `status` = '$requestData[show]' ";
...
$message = $string;
	...
	$nestedData[] = '<span class="badge badge-default" data-toggle="modal" data-target="#candidatejobalert" onClick="return viewbroadcast('.$row[id].');">View</span>';
