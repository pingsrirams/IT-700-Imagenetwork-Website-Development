...
if($row['wallet_balance']!=""){ 
	...
	$nestedData[] = '<span><a href="packedit/'.$row[id].'"><i class="ti-pencil-alt color-success"></i></a></span><span><a href="javascript:void(0);" onClick="return deletePack('.$row['id'].');"><i class="ti-trash color-danger"></i> </a></span>';
