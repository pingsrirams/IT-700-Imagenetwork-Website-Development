...
if(isset($_REQUEST['replysubmit'])){
	


	$ins= insert($con, "support","");

divert(ADMIN_URL.'/'.$filenames.'/replied');
        ...
        buttons: [
            ...
            'copy', 'csv', 'excel', 'pdf', 'print'
                    ...
                    "ajax":{
                        ...
                        url :"ajax-tickets.php", // json datasource
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Mange User Packages</li>
  ...
  <div class="modal-dialog modal-dialog-centered bd-example-modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle" >Ticket Reply</h5>
        ...
        <form method="post" id="add-wallet-form">
            <div class="modal-body" id="add_wallet">
              ...
              <div class="modal-footer">
                ...
                <input type="submit" name="replysubmit" class="btn btn-primary" value="Send">
...
<script type="text/javascript">
	function setInActive(user_id){
		...
		$.ajax({
			type :'post',
			url : 'ajax-ticket.php?action=inactive',
    ...
    function deleteTicket(id){
        ...
        $.ajax({
            type :'post',
            url : 'ajax-ticket.php?action=delete',
            data :'id='+id,
            success : function (data){
                location.reload();
            }
...
//alert(str);
    ...
    xmlhttp.open("GET","ajax-ticket.php?action=getticket&id="+str,true);
    xmlhttp.send();
}
</script>
