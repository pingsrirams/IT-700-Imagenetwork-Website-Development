...
.table>thead>tr>td, .table>thead>tr>th {color:#fff;}
    ...
    {   "defaultContent": "-","orderable": false, "targets": 0,"targets": 1 }
                    ...
                    "ajax":{
                        ...
                        url :"ajax-joinedlist.php", // json datasource
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Mange Joined list</li>
                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-header m-b-20">
                                ...
                                <h4>Joined list Search Information</h4>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="basic-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control border-none input-flat bg-ash" placeholder="Tournament Name">
