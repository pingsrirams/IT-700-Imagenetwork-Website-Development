...
.table>thead>tr>td, .table>thead>tr>th {color:#fff;}
    ...
    {   "defaultContent": "-","orderable": false, "targets": 0,"targets": 1 }
                    ...
                    "ajax":{
                        ...
                        url :"ajax-employeeinfo.php", // json datasource
...
<body  onLoad="select_query()";>
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1> Manage Employee<span> </span> </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Mange Employee</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="card-header m-b-20">
                                <h4>Employee Search Information</h4>
                                ...
                                <div class="col-md-2">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control border-none input-flat bg-ash" placeholder="Name">
                                        </div>
                                    </div>
                                </div>
	...
	function setInActive(id){
		...
		$.ajax({
			type :'post',
			url : 'ajax-employeestatus.php?action=inactive',
			data :'id='+id,
	...
	function setActive(id){
		...
		$.ajax({
			type :'post',
			url : 'ajax-employeestatus.php?action=active',
			data :'id='+id,
			success : function (data){
				location.reload();
			}
