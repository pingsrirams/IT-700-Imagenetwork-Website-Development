...
.table>thead>tr>td, .table>thead>tr>th {color:#fff;}
    ...
    {   "defaultContent": "-","orderable": false, "targets": 0,"targets": 1 }
                    ...
                    "ajax":{
                        ...
                        url :"ajax-tournmentlist.php", // json datasource
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-title">
                                ...
                                <h1> Manage Tournament <span> </span> </h1>
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Mange Tournament</li>
                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-header m-b-20">
                                ...
                                <h4>Tournament Search Information</h4>
