...
if($_REQUEST['action'] == 'delete') {
    ...
    mysqli_query($con,"DELETE FROM `user` where `id` = '$_REQUEST[id]' ")or die(mysqli_error($con));
    
}

if($_REQUEST['action'] == 'active') {

    mysqli_query($con,"UPDATE  `user` SET `status`  = 'Active' where `id` = '$_REQUEST[id]' ")or die(mysqli_error($con));
    
}

if($_REQUEST['action'] == 'inactive') {

    mysqli_query($con,"UPDATE  `user` SET `status`  = 'InActive' where `id` = '$_REQUEST[id]' ")or die(mysqli_error($con));
    
}

if($_REQUEST['action'] == 'activeuserpackage') {

    mysqli_query($con,"UPDATE  `user_package` SET `status`  = 'Active' where `id` = '$_REQUEST[id]' ")or die(mysqli_error($con));
    
}

if($_REQUEST['action'] == 'inactiveuserpackage') {

    mysqli_query($con,"UPDATE  `user_package` SET `status`  = 'InActive' where `id` = '$_REQUEST[id]' ")or die(mysqli_error($con));
