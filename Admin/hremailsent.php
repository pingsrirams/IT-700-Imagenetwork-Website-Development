        ...
        buttons: [
            ...
            'copy', 'csv', 'excel', 'pdf', 'print'
                    ...
                    "ajax":{
                        ...
                        url :"ajax-hremailsent.php", // json datasource
...
<script type="text/javascript">
    ...
    function viewMessage(log_id){
        ...
        $.ajax({
            ...
            data : 'action=log_viewmessage&log_id='+log_id,
    ...
    $('#email_pop_up').on('hidden.bs.modal', function () {

   $('#email_pop_up .modal-body').html('');

})



    function approve(as_id){
        ...
        if (confirm("Are your sure you want to approve this Email?")) {
            ...
            $.ajax({
                ...
                data : 'action=approveemail&as_id='+as_id,
...
function disapprove(as_id){
        ...
        if (confirm("Are your sure you want to reject this Email?")) {
            ...
            $.ajax({
                ...
                data : 'action=disapproveemail&ds_id='+as_id,
