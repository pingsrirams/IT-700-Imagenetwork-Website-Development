...
$nestedData[] = '<span><a href="modedit/'.$row[id].'"><i class="ti-pencil-alt color-success"></i></a></span><span><a href=""><i class="ti-trash color-danger"></i> </a></span><span><a href="javascript:void(0);" onClick="return deleteMode('.$row['id'].');"><i class="fa fa-inr color-warning"></i> </a></span>';
