        ...
        buttons: [
            ...
            'copy', 'csv', 'excel', 'pdf', 'print'
                    ...
                    "ajax":{
                        ...
                        url :"ajax-scheduledemail.php", // json datasource

                        type: "post", 

                        data :{'sort_by':sort_by,'show':show_1} ,
                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="card-header m-b-20">
                                <h4>Email Search Information</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-header pr">
                                    <h4>Email Lists (<?=$sort_by_name?>)</h4>
...
<div class="modal fade" id="email_pop_up" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
...
<script type="text/javascript">
    function showUserList(be_id){
        $.ajax({
            type : 'post',
            url : 'ajax-emailusers.php',
            data : 'action=getuserlist&be_id='+be_id,
    ...
    function viewMessage(be_id){
        $.ajax({
            type : 'post',
            url : 'ajax-emailusers.php',
            data : 'action=be_viewmessage&be_id='+be_id,
            async:false,
            beforeSend : function() {
                 
            },
            success : function(data){
                    $('#email_pop_up .modal-body').html(data);
                       $('#email_pop_up').modal('show');
    ...
    function approve(ae_id){
        if (confirm("Are your sure you want to approve this Email?")) {
            $.ajax({
                type : 'post',
                url : 'ajax-emailusers.php',
                data : 'action=approveemail&ae_id='+ae_id,
                success : function(data){
...
function disapprove(ae_id){
        if (confirm("Are your sure you want to reject this Email?")) {
            $.ajax({
                type : 'post',
                url : 'ajax-emailusers.php',
                data : 'action=disapproveemail&de_id='+ae_id,
                success : function(data){
                      alert('Content Disapproved. Email refunded.');    
                         if ( $.fn.dataTable.isDataTable('#employee-grid') ) {
                   table = $('#employee-grid').DataTable();   table.destroy();
                }
