        ...
        buttons: [
            ...
            'copy', 'csv', 'excel', 'pdf', 'print'
                    ...
                    "ajax":{
                        ...
                        url :"ajax-hrresumeaccess.php", // json datasource
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-title">
                                ...
                                <h1> Manage User sms<span> </span> </h1>
                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-header m-b-20">
                                ...
                                <h4>Resume Access Search Information</h4>
...
<script type="text/javascript">
    ...
    function approve(as_id){
        ...
        if (confirm("Are your sure you want to approve this Resume Access?")) {
    ...
    function disapprove(as_id){
        ...
        if (confirm("Are your sure you want to reject this Resume Access?")) {
            ...
            $.ajax({
                ...
                success : function(data){
                        ...
                        alert('Content Disapproved. Resume Access refunded.');
