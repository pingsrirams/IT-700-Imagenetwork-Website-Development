        ...
        buttons: [
            ...
            'copy', 'csv', 'excel', 'pdf', 'print'
                    ...
                    "ajax":{
                        ...
                        url :"ajax-packages.php", // json datasource
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-title">
                                ...
                                <h1> Manage User Packages<span> </span> </h1>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="basic-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-none input-flat bg-ash" placeholder="Mode Name" name="mode">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="basic-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-none input-flat bg-ash" placeholder="Pack Name" name="pack">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="basic-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-none input-flat bg-ash" placeholder="Validity" name="validity">
...
<script type="text/javascript">
	 function setInActive(user_id){
        ...
        $.ajax({
            type :'post',
            url : 'ajax-package.php?action=inactive',
            data :'id='+user_id,
    ...
    function setActive(user_id){
        ...
        $.ajax({
            type :'post',
            url : 'ajax-package.php?action=active',
            data :'id='+user_id,
            success : function (data){
                location.reload();
            }
    ...
    function deletePackage(id){
        if(confirm('Are you sure want to delete the Package?')){
        $.ajax({
            type :'post',
            url : 'ajax-package.php?action=delete',
            data :'id='+id,
            success : function (data){
                location.reload();
            }
