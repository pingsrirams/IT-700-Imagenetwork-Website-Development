...
} else {  $alert = $subid2;  $buttonname = "Update Pack"; }

if($alert=="insert"){
$succAlert = "Pack Created Sucessfully.";
...
mysqli_query($con,"update `$maindatabase` set `url`='$url' where `id`='$editid'");
	...
	divert(ADMIN_URL.'packedit/'.$editid.'/updated'); }
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1> <?php echo $title; ?> Pack<span> </span> </h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
