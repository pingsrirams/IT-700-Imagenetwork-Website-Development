...
.table>thead>tr>td, .table>thead>tr>th {color:#fff;}
    ...
    {   "defaultContent": "-","orderable": false, "targets": 0,"targets": 1 }
                    ...
                    "ajax":{
                        ...
                        url :"ajax-hrinfo.php", // json datasource
                ...
                <div id="main-content">
                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="card-body">
							...
							<button type="submit" id="search-btn" class="btn btn-default btn-lg m-b-10 bg-warning border-none m-r-5 sbmt-btn" type="submit">Search</button>
