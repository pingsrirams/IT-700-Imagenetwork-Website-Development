        ...
        buttons: [
            ...
            'copy', 'csv', 'excel', 'pdf', 'print'
                    ...
                    "ajax":{
                        ...
                        url :"ajax-hrsmssent.php", // json datasource
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card alert">
                                ...
                                <div class="card-header pr">
                                    ...
                                    <h4>Message Sent Users Information</h4>
...
<script type="text/javascript">
    ...
    function viewMessage(log_id){
        ...
        $.ajax({
            ...
            beforeSend : function() {
                   ...
                   $('#sms_pop_up').modal('show');

            },

            success : function(data){

                    $('#sms_pop_up .modal-body').html(data);
    ...
    function approve(as_id){
        ...
        if (confirm("Are your sure you want to approve this SMS?")) {
            ...
            $.ajax({
                ...
                data : 'action=approvesms&as_id='+as_id,
        ...
        buttons: [
            ...
            'copy', 'csv', 'excel', 'pdf', 'print'
                    ...
                    "ajax":{
                        ...
                        url :"ajax-scheduledsms.php", // json datasource
...
function disapprove(as_id){
        ...
        if (confirm("Are your sure you want to reject this SMS?")) {
            ...
            $.ajax({
                ...
                data : 'action=disapprovesms&ds_id='+as_id,
