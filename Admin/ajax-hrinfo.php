...
$sql.=" FROM hr_register";



$query=mysqli_query($con, $sql) or die("ajax-hrinfo.php: get employees");
...
$pack_age_type = '<span class="badge badge-pink">Premium</span>';
 ...
 $nestedData[] = $checkboxhtml;
	...
	$nestedData[] = date("d M Y", strtotime($date_time));
	...
	$nestedData[] = '<span ><a href="javascript:void(0);"><i class="ti-eye color-default"></i></a> </span><span><a href="tournmentedit/'.$row[hr_id].'"><i class="ti-pencil-alt color-success"></i></a></span>
