...
$nestedData[] = '<span><a href="modeedit/'.$row[id].'"><i class="ti-pencil-alt color-success"></i></a></span><span><a href="javascript:void(0);" onClick="return deleteMode('.$row['id'].');"><i class="ti-trash color-danger"></i> </a></span>';
