...
$sql ="SELECT * FROM `bulk_email` WHERE `id` ='$row[bulk_email_id]' ";



$beresult= mysqli_query($con, $sql) or die(mysqli_error($con));



$bulk_email_info = mysqli_fetch_array($hrresult);
...
$message = $string;
	...
	$nestedData[] = '<a class="color-primary sms_pop_up" data-toggle="modal" data-target="#email_pop_up" onClick="return viewMessage('.$row['id'].');">'.$message.'</a>';
