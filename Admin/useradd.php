...
<body>
    ...
    <div class="content-wrap">
		...
		<option value="<?php echo $locationv['id']; ?>" <?php if($value['city_id']==$locationv['id']){ echo "selected";} else {} ?>><?php echo $locationv['name']; ?></option>
		...
		<option value="<?php echo $locationv['id']; ?>" <?php if($value['package_id']==$locationv['id']){ echo "selected";} else {} ?>><?php echo $locationv['name']; ?></option>
