...
.table>thead>tr>td, .table>thead>tr>th {color:#fff;}
    ...
    {   "defaultContent": "-","orderable": false, "targets": 0,"targets": 1 }
                    ...
                    "ajax":{
                        ...
                        url :"ajax-withdrawlist.php", // json datasource
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Withdraw Request list</li>
                     ...
                     <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-header m-b-20">
                                ...
                                <h4>Withdraw Request list Search Information</h4>
