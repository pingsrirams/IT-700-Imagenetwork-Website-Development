        ...
        buttons: [
            ...
            'copy', 'csv', 'excel', 'pdf', 'print'
                    ...
                    "ajax":{
                        ...
                        url :"ajax-modelist.php", // json datasource
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Manage Modes</li>
...
<script type="text/javascript">
    function setInActive(user_id){
        ...
        $.ajax({
            type :'post',
            url : 'ajax-mode.php?action=inactive',
            data :'id='+user_id,
    ...
    function setActive(user_id){
        ...
        $.ajax({
            type :'post',
            url : 'ajax-mode.php?action=active',
            data :'id='+user_id,
            success : function (data){
                location.reload();
            }
    ...
    function deleteMode(id){
        if(confirm('Are you sure want to delete the Mode?')){
        $.ajax({
            type :'post',
            url : 'ajax-mode.php?action=delete',
            data :'id='+id,
            success : function (data){
                location.reload();
            }
