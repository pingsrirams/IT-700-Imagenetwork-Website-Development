            ...
            <form  method="post">
              ...
              <div class="mb-3">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  ...
                  <input id="prepaid" name="dthbillpayment" class="custom-control-input"  required type="radio">

                  <label class="custom-control-label" for="prepaid">SD Pack</label>

                </div>

                <div class="custom-control custom-radio custom-control-inline">

                  <input id="postpaid" name="dthbillpayment" class="custom-control-input" required type="radio">

                  <label class="custom-control-label" for="postpaid">HD Pack</label>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" data-bv-field="number" name="dthnumber" required placeholder="Enter Your Card Number">
        ...
        <div class="tab-content my-3" id="myTabContent">
          ...
          <div class="col-lg-6 text-center text-lg-left">
            ...
            <h2 class="text-9 font-weight-600 my-4">Starts from<br class="d-none d-lg-inline-block">
              ...
              <span class="text-danger">Rs.1990</span></h2>
          ...
          <div class="col-lg-6 text-center text-lg-left">
            ...
            <h2 class="text-9 font-weight-600 my-4">Starts from<br class="d-none d-lg-inline-block">
              ...
              <span class="text-danger">Rs.1790</span></h2>
          ...
          <div class="col-lg-6 text-center text-lg-left">
            ...
            <h2 class="text-9 font-weight-600 my-4">Starts from<br class="d-none d-lg-inline-block">
              ...
              <span class="text-danger">Rs.499</span></h2>

            <p class="lead">

					Now Sun Direct subscribers can upgrade old Set Top Box to latest one
    ...
    <div class="bg-light shadow-md py-5">
      ...
      <div class="container">
        ...
        <div class="owl-carousel owl-theme banner">
          ...
          <div class="item"><a href="#"><img class="img-fluid rounded" src="images/slider/small-banner-1.jpg" alt="banner" /></a></div>

          <div class="item"><a href="#"><img class="img-fluid rounded" src="images/slider/small-banner-2.jpg" alt="banner" /></a></div>

          <div class="item"><a href="#"><img class="img-fluid rounded" src="images/slider/small-banner-3.jpg" alt="banner" /></a></div>
