          ...
          <div class="bg-light shadow-md rounded p-4">
            ...
            <form id="recharge-bill" method="post">
              ...
              <div class="form-group  col-md-6">
                ...
                <input type="text" name="mobile" class="form-control" data-bv-field="number" id="mobileNumber" required placeholder="Enter Mobile Number">

              </div>

			  <div class="form-group  col-md-6">

                <input type="text" name="dth" class="form-control" data-bv-field="number" id="" required placeholder="Enter DTH Number">
              ...
              <button class="btn btn-primary" type="submit" name="support_ticket" >Submit</button>
