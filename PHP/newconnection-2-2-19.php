     ...
     <?php 
		  ...
		  <div class="col-12 col-sm-6 col-lg-4">
            ...
            <div class="form-group">
              ...
              <select onChange="return changePackage(this.value);" name="pack" class="custom-select" required="">
            ...
            <div class="form-group">
              ...
              <select class="custom-select" name="validity" required="">
               ...
               <option  <?=($_SESSION[validity] == '1' )?'selected':''?>  value="1">1 Month</option>
                  <option <?=($_SESSION[validity] == '3' )?'selected':''?> value="3">6 Month</option>
...
/*
                       mysqli_query($con,"select * from `packs` where 1 $pack_str ");*/
                        ...
                        $packages_result = mysqli_query($con,"select * from `packages`  where  1  $pack_str $mode_str ")or die(mysqli_error($con));
