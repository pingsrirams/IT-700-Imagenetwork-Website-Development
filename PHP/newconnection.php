...
if(isset($_REQUEST['recharge_bill_submit'])) {
    ...
    $order_id  = time() . $_SESSION[userid];
    mysqli_query($con,"INSERT INTO `user_package` (`id`, `user_id`, `package_id`, `order_id`,  `status`, `date_time`) VALUES (NULL, '$_SESSION[userid]', '$_REQUEST[package]','$order_id', 'Active','$datetime');")or die(mysqli_error($con));
...
<!--                                     <form id="recharge-bill"  action="" method="post">
          ...
          -->                
              ...
              <label for="agree" class="checkbox-custom-label"><input name="agree" type="checkbox" tabindex="12" checked="" />I agree to the Terms of Services</label>
